...
const Login = () => {
  ...
  const from = location.state?.from?.pathname || '/transform';
  ...
  const handleSubmit = async (e) => {
    ...
    console.log('Sending login credentials:', loginCredentials);
        ...
        >
          <Link to="/" className="inline-block">
            <motion.div
              ...
              className="w-16 h-16 bg-gradient-to-r from-primary-600 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg"
            >
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Sign in to your SortIQ account
          </p>
        </motion.div>
